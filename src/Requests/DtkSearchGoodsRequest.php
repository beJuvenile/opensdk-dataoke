 ...
 * 大淘客搜索
 *
 * @link: http://www.dataoke.com/pmc/api-d.html?id=9
 *
...
class DtkSearchGoodsRequest implements Request
{
     ...
     * @var string
     */
    public $method = '/goods/get-dtk-search-goods';
